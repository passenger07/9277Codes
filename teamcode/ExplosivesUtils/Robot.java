...
public class Robot {
    ...
    public DcMotorEx left, right, carouselMover, bleft, fleft, fright, bright,armBase,armTop;
    public int targetArmBaseP;
    public int targetArmTopP;
...
//        right.setDirection(DcMotorSimple.Direction.REVERSE);
        ...
        armTop=hardwareMap.get(DcMotorEx.class,"armTop");

        armBase.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        armBase.setTargetPosition(0);
        armBase.setMode(DcMotor.RunMode.RUN_TO_POSITION);
         targetArmBaseP=armBase.getCurrentPosition();
        targetArmTopP=armTop.getCurrentPosition();
...
//        left.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        ...
        armBase.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(0.1, 0.0, 0.0, 0.1));
        armTop.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(0.01, 0.0, 0.0, 0.1));
